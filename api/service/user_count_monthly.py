...
class Service:
    ...
    def _get_params(self, params):
        ...
        logger.debug(f'[API] UserCountMonthly uid : {self.uid}')
        logger.debug(f'[API] UserCountMonthly start_date : {self.start_date}')
        logger.debug(f'[API] UserCountMonthly end_date : {self.end_date}')
        logger.debug(f'[API] UserCountMonthly user_limit : {self.user_limit}')
    ...
    def _make_user_count(self):
        ...
        self.count_list = df_unpivot.to_dict('records')
